...
Gambar * loadTexture1() {
	...
	if (!GambarLoad("FLWR0021.bmp", gambar1)) {
		exit(1);
	}
	return gambar1;
}
...
Gambar * loadTexture2() {
	...
	//pic.bmp is a 64x64 picture
	if (!GambarLoad("logo.bmp", gambar2)) {
		exit(1);
	}
	return gambar2;
}
    ...
    //Tiang kanan
{
    glPushMatrix();
	glColor3f(1,1,1);
    glTranslatef(17.0, 25.0, 36.0);
    glScaled(5.0, 100 , 2.5);
    glutSolidCube(0.5f);
    glPopMatrix();
    ...
    glPushMatrix();
	glColor3f(1,1,1);
    glTranslatef(0.0, 45.0, 36.0);
    glScaled(65.0, 25.0 , 0.5);
    glutSolidCube(0.5f);
    glPopMatrix();
...
if(gerak>=-200)
{
glTranslated(gerak,20,155);
gerak-=2;
if (gerak==-200) {gerak=250;}
}

glRotated(180,0,1,0);
glScaled(2.3,3.6,2.4);
box();
glPopMatrix();

//dis kursi
glPushMatrix();
glTranslated(-156,0.5,-80);
...
glPushMatrix();
glTranslated(-150,0.5,106);
glScaled(2,2,2);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(40,0.5,120);
glScaled(2,2,2);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(135,-5,-71);
glScaled(3,3,3);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(-140,10,95);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(-160,10,95);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(-140,10,116);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(-160,10,116);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(40,10,105);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(30,10,115);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(20,10,126);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(155,10,-73);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(135,10,-53);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(120,10,-53);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(120,10,-73);
bunga();
glPopMatrix();

glPushMatrix();
glTranslated(129,10,-88);
bunga();
glPopMatrix();

//dis atap
glPushMatrix();
glTranslatef(-140,15,-50);
atap();
glPopMatrix();
//dis tiang
glPushMatrix();
glTranslatef(-140,20,-50);
tiang();
glPopMatrix();
//dis bawah
glPushMatrix();
...
//Marka Jalan
for( int a = 210; a > -230; a = a - 50 )
   {
        glPushMatrix();
        glTranslatef(a,19,164);
        glScalef(3, 3, 3);
        marka();
        glPopMatrix();
   }
...
for( int a = 210; a > -230; a = a - 50 )
   {
        glPushMatrix();
        glTranslatef(a,20,-164);
        glScalef(3, 3, 3);
        marka();
        glPopMatrix();
   }

for( int a = 120; a > -140; a = a - 50 )
   {
        glPushMatrix();
        glTranslatef(-220,20,a);
        glRotated(90, 0, 1, 0);
        glScalef(3, 3, 3);
        marka();
        glPopMatrix();
...
//PAGARKedai
        glPushMatrix();
        glTranslatef(-40, 20.30, 130);
        pagarkedai();
        glPopMatrix();
//pagarsamping
        glPushMatrix();
        glTranslatef(175, 20.30, 130);
        pagarsamping();
        glPopMatrix();
//pohon

	glPushMatrix();
	glTranslatef(180,20,-120);
	glScalef(7, 7, 7);
	pohon();
	glPopMatrix();

    glPushMatrix();
	glTranslatef(180,20,-90);
	glScalef(7, 7, 7);
	pohon();
	glPopMatrix();
    ...
    glPushMatrix();
	glTranslatef(150,20,120);
	glScalef(7, 7, 7);
	pohon();
	glPopMatrix();
	glPushMatrix();
	glTranslatef(120,20,120);
	glScalef(7, 7, 7);
	pohon();
	glPopMatrix();

  for( int a = 60; a > -190; a = a - 50 )
   {
	glPushMatrix();
	glTranslatef(-180,20,a);
	glScalef(7, 7, 7);
	pohon();
	glPopMatrix();
   }
//awan
glPushMatrix();
glTranslatef(0, 170, -150);
glScalef(1.8, 1.0, 1.0);
awan();
glPopMatrix();

glPushMatrix();
glTranslatef(70, 120, -150);
glScalef(1.8, 1.0, 1.0);
awan();
glPopMatrix();
